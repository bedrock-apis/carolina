...
export const ZigZong: ZigZongConstructor = VALUE_TYPE_CONSTRUCTOR_FACTORY("ZigZong", 0n, NumberType) as ZigZongConstructor;
...
mergeSourceDirectNoEnumerable(ZigZong, {
    ...
    encode: function encode(n: bigint): bigint { return (n << 1n) ^ (n >> 63n); },
    decode: function decode(n: bigint): bigint { return (n >> 1n) ^ -(n & 1n); }
});
